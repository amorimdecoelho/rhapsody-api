...
function Utils() {
   ...
   */
  function buildUrl(path, params, apikey, version) {
    version = version || config.version;
    var u = config.url + version + path + "?apikey=" + apikey;
    if (params !== null) {
  ...
  function buildMeUrl(path, version) {
    version = version || config.version;
    var u = "https://api.rhapsody.com/"+version+"/me" + path;
    return u;
  }
    /**
   * @private
